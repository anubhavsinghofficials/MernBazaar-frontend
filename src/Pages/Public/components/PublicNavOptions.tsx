...
function PublicNavOptions() {
    ...
    return (
    <DropdownMenu>
        <DropdownMenuTrigger className="bg-slate-800 text-slate-200 w-8 aspect-square rounded-md flex justify-center items-center text-xl hover:text-white hover:bg-slate-700 active:bg-slate-800 transition-colors duration-100 xs:text-2xl">
                <BsFillPersonFill/>
        </DropdownMenuTrigger>
