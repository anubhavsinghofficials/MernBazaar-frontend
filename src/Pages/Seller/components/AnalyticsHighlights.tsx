        ...
        <div className={`flex flex-col gap-y-4 xs:gap-y-8`}
         >            
            ...
            <div className={`grid grid-cols-1 xs:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-2 sm:gap-4`}>
               <div className={`bg-orange-50 shadow-md hover:shadow-lg active:shadow-sm duration-100 cursor-pointer rounded-lg p-[3%] flex gap-x-4`}>
               ...
               <div className={`bg-yellow-50 shadow-md hover:shadow-lg active:shadow-sm duration-100 cursor-pointer rounded-lg p-[3%] flex gap-x-4`}>
               ...
               <div className={`bg-sky-50 shadow-md hover:shadow-lg active:shadow-sm duration-100 cursor-pointer rounded-lg p-[3%] flex gap-x-4`}>
               ...
               <div className={`bg-green-50 shadow-md hover:shadow-lg active:shadow-sm duration-100 cursor-pointer rounded-lg p-[3%] flex gap-x-4`}>
